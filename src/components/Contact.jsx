  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name:"Varun Aaditya S",
          from_email: form.email,
          to_email: "varunaaditya9@gmail.com",
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
          ...
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.email}
              onChange={handleChange}
              placeholder="varunaaditya9@gmail.com"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
              disabled
            />
          </label>
          <label className='flex flex-col'>
            ...
            <input
              ...
              value={form.location}
              onChange={handleChange}
              placeholder="Tirchy, tamil Nadu, India"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium'
              disabled
            />
          </label>
          ...
          <label className="flex flex-col">
            <p className="text-center" style={{ color: "#7C7E80" }}>
              Copyright &copy; 2025 Varun Portfolio <br />
              Designed and Developed by
              <a href="http://www.linkedin.com/in/varun-aaditya27" onClick={openLinkedInProfile}>
                <strong> Varun Aaditya S</strong>
              </a>
            </p>
          </label>
        </form>
