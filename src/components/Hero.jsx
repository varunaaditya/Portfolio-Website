...
const Hero = () => {
  ...
  const typedItems = ["Fresher","Developer",  "Designer", "Learner"];
      ...
      >
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">VARUN AADITYA</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            <span
              ...
              aria-hidden="true"
              style={{
                // backgroundImage: "linear-gradient(to bottom, rgb(248, 245, 242), rgba(115, 13, 223, 0.5))",
            ...
            <br />
            <b> Ready to Work and gain knowledge!</b>
          </p>
        </div>
      </div>
      <br /><br /><br />
